...
qq.FineUploaderBasic = function(o){
    ...
    this._options = {
        ...
        messages: {
            typeError: "{file} 文件不在允许上传的范围内,只允许上传{extensions}类型文件",
            sizeError: "{file} 文件大小超过限制，最大只能是{sizeLimit}.",
            minSizeError: "{file} 文件太小了,文件最小不能小于{minSizeLimit}.",
            emptyError: "{file} 文件为空.",
            noFilesError: "没有需要上传的文件",
            onLeave: "文件尚未完全上传，离开将取消此次上传"
        },
        retry: {
            enableAuto: false,
            maxAutoAttempts: 3,
...
qq.FineUploader = function(o){
    ...
    qq.extend(this._options, {
        ...
        text: {
            ...
            failUpload: '上传失败',
            dragZone: '拖动文件到此完成上传',
            dropProcessing: '请稍后再拖动文件...',
            formatProgress: "已完成{percent}% ，总共{total_size}",
            waitingForResponse: "请稍后..."
        },
        ...
        messages: {
            tooManyFilesError: "一次只能拖动上传一个文件"
        },
        retry: {
        ...
        deleteFile: {
            forceConfirm: false,
            confirmMessage: "你确定要删除文件 {filename}?",
